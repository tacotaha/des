...
const int p_2[] = { 58, 50, 42, 34, 26, 18, 10, 2, 60,
  52, 44, 36, 28, 20, 12, 4, 62, 54, 46,
  38, 30, 22, 14, 6, 64, 56, 48, 40, 32,
  24, 16, 8, 57, 49, 41, 33, 25, 17, 9, 1,
  59, 51, 43, 35, 27, 19, 11, 3, 61, 53, 45,
...
uint64_t permute(uint64_t b, const int *perm, int plen) {
  uint64_t temp, result = 0;

  for (int i = 0; i < plen; ++i) {
    temp = (b & (1ULL << (perm[i] - 1))) >> (perm[i] - 1);
    result |= temp << i;
  }
